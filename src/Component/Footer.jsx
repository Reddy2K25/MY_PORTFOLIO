		...
		>
			<div className="md:w-1/3 ">
				...
				>
					...
					<div className="flex flex-col">
						...
						<div className=" text-xl md:text-base flex md:flex-row gap-5  items-center">
							...
							<a target="_blank"
								href="https://www.instagram.com/reddy__a_/"
							...
							<a target="_blank"
								href="https://www.linkedin.com/in/reddy2k25/"
								className="flex items-center gap-2"
							>
							...
							<a target="_blank"
								href="https://github.com/Reddy2K25"
								className="flex items-center gap-2"
							>
				...
				>
					...
					<div>
						<h1>Email</h1>
						<p className="text-base">reddy2k25@gmail.com</p>
					</div>
				</div>
				...
				<div className="flex gap-2 my-10 items-center text-2xl">
					...
					<div>
						...
						<p className="text-base"> Katakanur, Raichur Karnataka - 584202</p>
					</div>
				</div>
				<div className="flex gap-2 my-10 items-center text-2xl">
					...
					<div>
						...
						<p className="text-base">Katakanur, Raichur Karnataka - 584202</p> {/* Changed example data for clarity */}
					</div>
				</div>
